...
// exports.handler = async (event, gotText) => {
...
// vk.updates.on('message_new', async (gotText) => {
export const greetingHandler = async (gotText, context) => {
    'Знакомство'
    const text = gotText.text.trim().toLowerCase(); // 'Знакомство'
    let responseText = { message: '', keyboard: null };
