...
vk.updates.on('message_new', async (context) => {
    ...
    if (['привет', 'старт', 'начало'].includes(text.toLowerCase())) {
        ...
        await context.send({
            message: "Привет, дорогой путешественник!\n\n👋 Я — ваш виртуальный гид. Помогу вам выбрать идеальный тур, отвечу на вопросы и оформлю заявку. Чем могу помочь? Выберите опцию в меню ниже. Или напишите ваш вопрос прямо сюда, и я отвечу!😊",
