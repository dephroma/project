...
vk.updates.on('message_new', async (context) => {
    ...
    if (message === 'привет' || message ==='здравствуйте' || message ==='начать' || message ==='приветствую' || message ==='салам' || message ==='салам алейкум') {
        await context.send('Здравствуйте! Покафыв наш менеджер спешить ответить, я смогу помочь вам с поиском нужной информации. Напишите "туры", "даты", "цены/оплата" или "информация" для получения данных.');}
